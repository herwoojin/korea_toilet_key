...
export const MOCK_BUILDINGS: Building[] = [
  {
    ...
    createdByNickname: "데모운영자",
    createdAt: now - 30 * DAY,
    updatedAt: now - 2 * DAY,
    toilets: {
      male: { exists: true, locationDesc: "2층 엘리베이터 옆", hasPassword: true, confidence: "high", reportCount: 7, correctCount: 6, wrongCount: 0, lastConfirmedAt: now - 1 * DAY },
      female: { exists: true, locationDesc: "3층 계단 옆", hasPassword: true, confidence: "high", reportCount: 6, correctCount: 5, wrongCount: 1, lastConfirmedAt: now - 1 * DAY },
    },
  },
  {
    id: "demo-2",
    ...
    geohash: "",
    status: "active",
    createdByNickname: "급한토끼",
    createdAt: now - 20 * DAY,
    updatedAt: now - 5 * DAY,
    toilets: {
      male: { exists: true, locationDesc: "1층 로비 안쪽", hasPassword: true, confidence: "medium", reportCount: 3, correctCount: 2, wrongCount: 1, lastConfirmedAt: now - 4 * DAY },
      female: { exists: true, locationDesc: "1층 로비 안쪽", hasPassword: true, confidence: "medium", reportCount: 3, correctCount: 3, wrongCount: 0, lastConfirmedAt: now - 4 * DAY },
    },
  },
  {
    id: "demo-3",
