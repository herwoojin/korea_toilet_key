...
- ✅ **A-005** 지도 클릭 핀 등록 — 오렌지 대기 핀 + 폼(건물명/점포명/남자비번/여자비번), 역지오코딩 주소 자동 표시(Kakao→Nominatim 폴백), /api/report 남녀 동시 제보 확장
- ✅ **A-006** 핀 목록 표 — 컬럼 순서: 건물명·점포명·남자비번·여자비번·등록일·등록자·맞아요·틀려요. 비번은 탭 열람(기록 저장) 후 표시, 피드백 카운트 캐시(correctCount/wrongCount)
